...
/**
 * This class is used to start the platform and the agents. To launch your agents in the environment you desire you will
 * have to :
 * <ul>
...
public class Principal {
	...
	private static Runtime emptyPlatform(HashMap<String, ContainerController> containerList) {
		...
		// 3) create monitoring agents : rma agent, used to debug and monitor the platform; sniffer agent, to monitor
		// communications;
	 ...
	 *         note: there is a smarter way to find a container with its name, but we go fast to the goal here. Cf
	 *         jade's doc.
	 */
	 ...
	 * 
	 * @param containerName
	 * @param host          is the IP of the host where the main-container should be listen to. A null value means use
	 *                      the default (i.e. localhost)
	 * @param platformID    is the symbolic name of the platform, if different from default. A null value means use the
	 *                      default (i.e. localhost)
	...
	/**
	 * create the monitoring agents (rma+sniffer) on the main-container given in parameter and launch them. - RMA
	 * agent's is used to debug and monitor the platform; - Sniffer agent is used to monitor communications
	 * 
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		/************************************************************************************************
		 * The main container (now) exist, we deploy the agent(s) on their local containers They will have to find the
		 * gatekeeper's container to deploy themselves in the environment. This is automatically performed by all agent
		...
		/*****************************************************
		 * 
		 * ADD YOUR AGENTS HERE - As many as you want. Any agent added here should have its associated configuration
		 * available in the entities file
		 * 
		 *****************************************************/
		/*********
