...
/**
 * Configuration file for a Dedale instance 1) Network and platform parameters 2) Environment parameters
 * 
 * 
 * @author hc
 *
...
public final class ConfigurationFile {
	...
	/*
	 * 2-a) Environment parameters when the environment is loaded: (topology, map elements)
	 */
	...
	// used by the BARABASI_ALBERT generator to know the number of childs
